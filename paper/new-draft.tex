...
{\centering \includegraphics[width=0.72\linewidth,alt={A neural-network architecture diagram with eight input nodes, two hidden nodes, one output node, and directed connections between layers.}]{new-draft_files/figure-latex/example-plotnn-1} 
...
{\centering \includegraphics[width=0.72\linewidth,alt={A partial covariate-effect plot for body mass index, with body mass index on the horizontal axis and the estimated covariate effect on the vertical axis.}]{new-draft_files/figure-latex/example-pce-bmi-1} 
...
\begin{center}\includegraphics[width=0.72\linewidth]{new-draft_files/figure-latex/example-pce-delta-1} \end{center}
...
\begin{center}\includegraphics[width=0.72\linewidth]{new-draft_files/figure-latex/example-pce-interaction-1} \end{center}
